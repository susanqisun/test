...
outlets = pd.read_csv("https://raw.githubusercontent.com/jasonchia89/GA_Capstone_Flask/master/flaskr/outlets.csv")
...
def getvalues_and_recommend():
    ...
    mbcf = newspark.read.csv('https://raw.githubusercontent.com/jasonchia89/GA_Capstone_Flask/master/flaskr/mbcf.csv', header=True, inferSchema=True)
